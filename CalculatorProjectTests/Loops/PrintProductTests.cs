    ...
    public class PrintProductTests
    {
        ...
        public void GetProductsGreaterThan30WithForTest()
        {
            if (PrintProduct.products.Count == 0)
                ...
                Assert.IsTrue(PrintProduct.GetProductsGreaterThan30WithFor()[0].Name=="Aceite");                Assert.IsTrue(PrintProduct.GetProductsGreaterThan30WithFor()[0].Name=="Aceite");
        ...
        public void GetProductsGreaterThan30WithForEachTest()
        {
            if (PrintProduct.products.Count == 0)
                ...
                Assert.IsTrue(PrintProduct.GetProductsGreaterThan30WithForEach()[0].Name == "Aceite"); Assert.IsTrue(PrintProduct.GetProductsGreaterThan30WithFor()[0].Name == "Aceite");
        ...
        public void GetProductsGreaterThan30WithLinqTest()
        {
            if (PrintProduct.products.Count == 0)
                ...
                Assert.IsTrue(PrintProduct.GetProductsGreaterThan30WithLinq()[0].Name == "Aceite"); Assert.IsTrue(PrintProduct.GetProductsGreaterThan30WithFor()[0].Name == "Aceite");
